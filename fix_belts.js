...
const map = {
  ...
  'qqqq': 'Old',
  'safaribag': 'Safari',
  'none': 'None' // Capitalize None as well for consistency if we want, but let's stick to what's expected. The user said "none hariç" (except none).
};
...
console.log('Updated all individual JSON files.');
